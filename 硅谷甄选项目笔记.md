...
```
pnpm add sass sass-loader stylelint postcss postcss-scss postcss-html stylelint-config-prettier(出问题) stylelint-config-recess-order stylelint-config-recommended-scss stylelint-config-standard() stylelint-config-standard-vue stylelint-scss stylelint-order stylelint-config-standard-scss -D
```
