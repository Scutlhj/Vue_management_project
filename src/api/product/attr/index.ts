...
export const reqGetCategory2 = (id: number) =>
  request.get<any, CategoryResponseData>(API.CATEGORY2_URL + id)

export const reqGetCategory3 = (id: number) =>
  request.get<any, CategoryResponseData>(API.CATEGORY3_URL + id)

// 获取对应分类下的属性与属性值
export const reqGetAttr = (c1id: number, c2id: number, c3id: number) =>
