    ...
    <el-card shadow="always" :body-style="{ padding: '20px' }">
        ...
        <el-form inline>
            <el-form-item label="一级分类" size="default" label-width="80px">
                <el-select v-model=categoryStore.c1SelectedId @change="getCategory2" :disabled="scene">
            ...
            <el-form-item label="二级分类" size="default" label-width="80px">
                <el-select v-model=categoryStore.c2SelectedId @change="getCategory3" :disabled="scene">
            ...
            <el-form-item label="三级分类" size="default" label-width="80px">
                <el-select v-model=categoryStore.c3SelectedId :disabled="scene">
